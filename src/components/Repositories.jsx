...
const Repositories = () => {
  ...
  return (
    <div className="  w-full md:py-4 md:px-3 p-0">
      {/* <div className=" h-full w-full md:rounded-xl shadow-md shadow-gray-500 "> */}
        <div className="rounded-xl border border-[#E9EAEB] bg-white shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)]">
        <div className="w-full p-5 md:space-y-3 space-y-5">
          ...
          <div className="shadow-sm md:w-[366px] sm:w-[408px] w-full h-11  border rounded-lg flex items-center   pl-3 bg-white">
            ...
            <input
              ...
              className="w-full h-full mx-3 border placeholder:text-white-500 border-gray-200 outline-none focus:border-2  border-none  "
            />
          </div>
        </div>
